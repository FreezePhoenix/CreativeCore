...
public class ConfigTypeArray extends ConfigTypeConveration {
	...
	@Override
	public Object readElement(Object defaultValue, boolean loadDefault, boolean ignoreRestart, JsonElement element, EnvType side,
		...
		if (element.isJsonArray()) {
			...
			for (int i = 0; i < size; i++)
				Array.set(
						object,
						i,
						read(defaultValue.getClass().getComponentType(),
	...
	@Override
	public JsonElement writeElement(Object value, Object defaultValue, boolean saveDefault, boolean ignoreRestart, EnvType side,
	                                @Nullable ConfigKeyField key) {
