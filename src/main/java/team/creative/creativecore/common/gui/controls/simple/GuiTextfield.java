...
public class GuiTextfield extends GuiFocusControl {
	...
	protected void renderContent(PoseStack matrix, GuiChildControl control, Rect rect, int mouseX, int mouseY) {
		...
		int color = enabled
		            ? style.fontColor.toInt()
		            : style.fontColorDisabled.toInt();
	...
	public String getSelectedText() {
		int i = this.cursorPosition < this.selectionEnd
		        ? this.cursorPosition
		        : this.selectionEnd;
		int j = this.cursorPosition < this.selectionEnd
		        ? this.selectionEnd
		        : this.cursorPosition;
