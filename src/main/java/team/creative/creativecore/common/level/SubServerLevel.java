...
public class SubServerLevel extends CreativeServerLevel implements ISubLevel {
	...
	public static CreativeLevel createSubLevel(Level level) {
		if (level instanceof ServerLevel) return new SubServerLevel(level, 6);
	...
	public void setOrigin(Vec3d center) {
		...
		else this.origin = new VecOrigin(center);
	}
	...
	public Level getRealLevel() {
		if (parentLevel instanceof SubServerLevel) return ((SubServerLevel) parentLevel).getRealLevel();
		return parentLevel;
	}

	@Override
	public void playSound(@Nullable
			                      Player p_184133_1_, BlockPos pos, SoundEvent p_184133_3_, SoundSource p_184133_4_, float p_184133_5_, float p_184133_6_) {
		if (getOrigin() == null) return;
		getRealLevel().playSound(
				p_184133_1_,
				transformToRealWorld(pos),
				p_184133_3_,
				p_184133_4_,
				p_184133_5_,
				p_184133_6_
	...
	@Override
	public void playSound(@Nullable
			                      Player p_184148_1_, double x, double y, double z, SoundEvent p_184148_8_, SoundSource p_184148_9_, float p_184148_10_, float p_184148_11_) {
		if (getOrigin() == null) return;
	...
	@Override
	public void playSound(@Nullable
			                      Player p_217384_1_, Entity entity, SoundEvent p_217384_3_, SoundSource p_217384_4_, float p_217384_5_, float p_217384_6_) {
		if (getOrigin() == null) return;
	...
	public void addAlwaysVisibleParticle(ParticleOptions p_195589_1_, double x, double y, double z, double p_195589_8_, double p_195589_10_, double p_195589_12_) {
		if (getOrigin() == null) return;
		Vector3d vec = getOrigin().transformPointToWorld(new Vector3d(x, y, z));
		getRealLevel().addAlwaysVisibleParticle(
				p_195589_1_,
				vec.x,
				vec.y,
				vec.z,
